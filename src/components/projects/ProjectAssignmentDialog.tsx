      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <ProjectAssigneeSelector selectedUserIds={selectedUserIds} onSelectionChange={setSelectedUserIds} disabled={isLoading || assignmentMutation.isPending} />
          </div>
          ...
          <div className="flex justify-end space-x-2 pt-4 border-t">
            ...
            <Button onClick={handleSave} disabled={assignmentMutation.isPending}>
