        ...
        <Table>
          ...
          <TableBody>
            {reportData.map((entry) => {
              ...
              // Get the project or contract name based on entry_type
              let projectContractName = '';
              if (entry.entry_type === 'project' && entry.project?.name) {
                projectContractName = entry.project.name;
              } else if (entry.entry_type === 'contract' && entry.contract?.name) {
                projectContractName = entry.contract.name;
              }
              ...
              return (
                <TableRow key={entry.id}>
                  ...
                  <TableCell>{projectContractName || '-'}</TableCell>
