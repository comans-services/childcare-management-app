...
interface ContractAssigneeSelectorProps {
...
const ContractAssigneeSelector: React.FC<ContractAssigneeSelectorProps> = ({
  selectedUserIds,
  onSelectionChange,
  disabled = false,
  className,
...
export default ContractAssigneeSelector;
