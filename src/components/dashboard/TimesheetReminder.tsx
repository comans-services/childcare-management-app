      ...
      <CardContent>
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className={cardStyle.text}>
            {hasEntries && !completeWeek 
              ? caughtUp 
                ? "Congratulations! You have caught up to your expected days." 
                : `${daysRemaining} days remaining to reach your weekly target of ${workingDays} days`
              : deadlineMessage
            }
          </span>
        </div>
        <div className="mt-2">
          <div className="flex justify-between text-sm mb-1">
            ...
            <span className={cardStyle.text}>
              {hasEntries 
                ? `${Math.round(weekProgress)}% Complete (${workingDays} days target)`
                : "No entries yet"
              }
            </span>
          </div>
