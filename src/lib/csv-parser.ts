...
export const generateCSVTemplate = (entityType: 'projects' | 'customers' | 'contracts' | 'team-members'): string => {
  const templates = {
    ...
    'team-members': 'full_name,email,password,role,employment_type,employee_id,employee_card_id\n"Jane Smith","jane@company.com","TempPass123","employee","full-time","EMP001","CARD001"\n"John Doe","john@company.com","TempPass456","admin","casual","EMP002","CARD002"'
  };
