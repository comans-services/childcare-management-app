...
-- Update the timesheet_entries_report function to support entry type filtering
CREATE OR REPLACE FUNCTION public.timesheet_entries_report(
  ...
  p_include_projects boolean DEFAULT true,
  p_include_contracts boolean DEFAULT true
)
RETURNS TABLE(
  id uuid, 
  user_id uuid, 
