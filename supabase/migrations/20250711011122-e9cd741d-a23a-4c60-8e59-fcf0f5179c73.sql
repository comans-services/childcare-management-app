...
-- Add audit trigger for leave balance operations
CREATE TRIGGER tr_leave_balance_operations_audit
  AFTER INSERT OR UPDATE OR DELETE ON public.leave_balance_operations
