...
-- Update the INSERT trigger function to handle profiles table
...
-- Update the UPDATE trigger function to handle profiles table
...
-- Update the DELETE trigger function to handle profiles table
...
-- Update the action types function to include member actions
