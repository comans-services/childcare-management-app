...
DROP FUNCTION IF EXISTS public.timesheet_entries_report(date, date, uuid, uuid, uuid, uuid);

-- Recreate the function with the updated return type and entry_type filtering
